...
function renderInitialTasks() {
  fetchFn('http://localhost:3000/tasks')
  .then(array => {
    tasksArray = array;
...
renderInitialTasks();
  ...
  const handleSubmit = e => {
    ...
    //console.log(fetchFn('http://localhost:3000/tasks'))
    fetchFn('http://localhost:3000/tasks')
    .then(array => {
      tasksArray = array
      console.log('old taskArray: ', tasksArray)
      tasksArray.push({name: textField.value, priority: selectMenu.value})
      tasksArray = sortByPriority(tasksArray);
      console.log('new taskArray: ', tasksArray)
      
      postTask(textField.value, selectMenu.value);
      console.log('after postTask')
      ...
      for (let task of tasksArray) {
        ...
        createTodo(task.name, task.priority, task.id);
      }
      textField.value = '';
    })
}
  ...
  function fetchFn(url, configObj) {
  ...
  function postTask(task, priority) {
    ...
    fetchFn('http://localhost:3000/tasks', configObjMaker({name: task, priority}))
    .then(res => console.log(res))
    .catch(e => console.error('Problem posting: ', e))
  }

  // Create li for tasks
  const createTodo = (name, priority, taskID) => {
    ...
    deleteBtn.addEventListener('click', e => {
      ...
      parent.remove();
      console.log('id in eventListener: ', taskID)
      deleteTodo(taskID)
    })
...
function deleteTodo(taskID) {
  console.log(taskID)
   fetch(`http:localhost:3000/tasks/${taskID}`, {
    ...
    .catch(e => console.log('problem deleting: ', e))
}
    //=================== PROBLEM CODE ===============================
...
//========================================================================================
//===================   PRIMARY =====================================
//===============  HAS INITIAL RENDER FUNCTIONALITY =====================
// document.addEventListener("DOMContentLoaded", () => {
//   // your code here
//   const form = document.querySelector("#create-task-form")
//   const submitBtn = document.querySelector('#new-task-submit')
...
//========================================================      ==========================
//==========================================================  ============================
//================================  BUT NO INITIAL RENDER FUNCTIONALITY =====================
